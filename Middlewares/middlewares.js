...
/* ------------------------------------------------------- *
//* next() for next callBackFunction: middleware callback olarak kullanılabilir.
...
const middleFunction2 = (req, res, next) => {
    ...
    // next() // next() komutu ile aşağıdakiler çalışmaz ve middleware1 deki bilgiler taşınır
